...
const privateKey = fs.readFileSync('encryptionkeys/jwt_1.txt', 'utf8')
...
exports.authorize = (user = {}) => jwt.sign(user, privateKey, { expiresIn: 60 * 60, algorithm: 'RS256' })
exports.verify = (token) => jws.verify(token, publicKey, {algorithm: ['RS256']})
