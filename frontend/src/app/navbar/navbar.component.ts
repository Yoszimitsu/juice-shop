...
import {TranslateService, SecurityContext} from '@ngx-translate/core'
...
export class NavbarComponent implements OnInit {
  ...
  search(value: string) {
    if (value) {
      var sanitizedValue = this.sanitizer.sanitize(SecurityContext.HTML, value);
  ...
  logout() {
    this.userService.saveLastLoginIp().subscribe((user: any) => {
      this.noop()
    }, (err) => console.log(err))
